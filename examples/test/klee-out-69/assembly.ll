...
entry:
  ...
  store i32 %4, i32* @a, align 4, !dbg !78
  %5 = call noalias i8* @malloc(i32 4) nounwind, !dbg !79
  %6 = bitcast i8* %5 to i32*, !dbg !79
  store i32* %6, i32** @pi, align 4, !dbg !79
  %7 = load i32** @pi, align 4, !dbg !80
  store i32 100, i32* %7, align 4, !dbg !80
  %8 = load i32** @pi, align 4, !dbg !81
  store i32 234, i32* %8, align 4, !dbg !81
  %9 = load i32* @a, align 4, !dbg !82
  %10 = icmp ne i32 %9, 0, !dbg !82
  br i1 %10, label %bb, label %bb1, !dbg !82

bb:                                               ; preds = %entry
  store i32 1, i32* @ai, align 4, !dbg !83
  br label %bb2, !dbg !83

bb1:                                              ; preds = %entry
  store i32 2, i32* @ai, align 4, !dbg !84
  br label %bb2, !dbg !84

bb2:                                              ; preds = %bb1, %bb
  store i32 0, i32* %0, align 4, !dbg !85
  %11 = load i32* %0, align 4, !dbg !85
  store i32 %11, i32* %retval, align 4, !dbg !85
  %retval3 = load i32* %retval, !dbg !85
  ret i32 %retval3, !dbg !85
}
...
!82 = metadata !{i32 20, i32 0, metadata !74, null}
!83 = metadata !{i32 22, i32 0, metadata !74, null}
!84 = metadata !{i32 26, i32 0, metadata !74, null}
!85 = metadata !{i32 28, i32 0, metadata !74, null}
