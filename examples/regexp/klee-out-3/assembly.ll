...
entry:
  ...
  %re_addr = alloca i8*, align 4
  %text_addr = alloca i8*, align 4
  %retval = alloca i32
  %0 = alloca i32
...
bb:                                               ; preds = %bb4, %bb3, %entry
  %1 = load i8** %re_addr, align 4, !dbg !72
  %2 = load i8** %text_addr, align 4, !dbg !72
...
bb3:                                              ; preds = %bb2
  ...
  %14 = load i8** %text_addr, align 4, !dbg !75
  %15 = getelementptr inbounds i8* %14, i64 1, !dbg !75
  store i8* %15, i8** %text_addr, align 4, !dbg !75
...
entry:
  ...
  store i8* %re, i8** %re_addr
  store i8* %text, i8** %text_addr
  %1 = load i8** %re_addr, align 4, !dbg !77
  %2 = getelementptr inbounds i8* %1, i32 0, !dbg !77
...
bb6:                                              ; preds = %bb4, %bb3
  %28 = load i8** %text_addr, align 4, !dbg !84
  %29 = load i8* %28, align 1, !dbg !84
  %30 = icmp ne i8 %29, 0, !dbg !84
  br i1 %30, label %bb7, label %bb10, !dbg !84

bb7:                                              ; preds = %bb6
  %31 = load i8** %re_addr, align 4, !dbg !84
  %32 = getelementptr inbounds i8* %31, i32 0, !dbg !84
  %33 = load i8* %32, align 1, !dbg !84
  %34 = icmp eq i8 %33, 46, !dbg !84
  br i1 %34, label %bb9, label %bb8, !dbg !84

bb8:                                              ; preds = %bb7
  %35 = load i8** %re_addr, align 4, !dbg !84
  %36 = getelementptr inbounds i8* %35, i32 0, !dbg !84
  %37 = load i8* %36, align 1, !dbg !84
  %38 = load i8** %text_addr, align 4, !dbg !84
  %39 = load i8* %38, align 1, !dbg !84
  %40 = icmp eq i8 %37, %39, !dbg !84
  br i1 %40, label %bb9, label %bb10, !dbg !84

bb9:                                              ; preds = %bb8, %bb7
  %41 = load i8** %text_addr, align 4, !dbg !85
  %42 = getelementptr inbounds i8* %41, i32 1, !dbg !85
  %43 = load i8** %re_addr, align 4, !dbg !85
  %44 = getelementptr inbounds i8* %43, i32 1, !dbg !85
...
entry:
  ...
  store i8* %re, i8** %re_addr
  store i8* %text, i8** %text_addr
  %1 = load i8** %re_addr, align 4, !dbg !87
  %2 = getelementptr inbounds i8* %1, i32 0, !dbg !87
  %3 = load i8* %2, align 1, !dbg !87
  %4 = icmp eq i8 %3, 94, !dbg !87
  br i1 %4, label %bb, label %bb1, !dbg !87

bb:                                               ; preds = %entry
  %5 = load i8** %re_addr, align 4, !dbg !89
  %6 = getelementptr inbounds i8* %5, i32 1, !dbg !89
  %7 = load i8** %text_addr, align 4, !dbg !89
  %8 = call i32 @matchhere(i8* %6, i8* %7) nounwind, !dbg !89
  store i32 %8, i32* %0, align 4, !dbg !89
  br label %bb5, !dbg !89

bb1:                                              ; preds = %bb3, %entry
  %9 = load i8** %re_addr, align 4, !dbg !90
  %10 = load i8** %text_addr, align 4, !dbg !90
...
entry:
  ...
  call void @klee_make_symbolic(i8* %re1, i32 7, i8* getelementptr inbounds ([3 x i8]* @.str, i32 0, i32 0)) nounwind, !dbg !94
  %1 = getelementptr inbounds [7 x i8]* %re, i32 0, i32 0, !dbg !96
  %2 = load i8* %1, align 1, !dbg !96
  %3 = icmp eq i8 %2, 104, !dbg !96
  %4 = zext i1 %3 to i32, !dbg !96
  call void @klee_assume(i32 %4) nounwind, !dbg !96
  %re2 = bitcast [7 x i8]* %re to i8*, !dbg !97
  %5 = call i32 @match(i8* %re2, i8* getelementptr inbounds ([6 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !97
  store i32 0, i32* %0, align 4, !dbg !98
  %6 = load i32* %0, align 4, !dbg !98
  store i32 %6, i32* %retval, align 4, !dbg !98
  %retval3 = load i32* %retval, !dbg !98
  ret i32 %retval3, !dbg !98
}
...
!1 = metadata !{i32 589865, metadata !"Regexp.c", metadata !"/home/shaw/work/klee/examples/regexp/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"Regexp.c", metadata !"/home/shaw/work/klee/examples/regexp/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!16 = metadata !{i32 589865, metadata !"memcpy.c", metadata !"/home/shaw/work/klee/runtime/Intrinsic/", metadata !17} ; [ DW_TAG_file_type ]
!17 = metadata !{i32 589841, i32 0, i32 1, metadata !"memcpy.c", metadata !"/home/shaw/work/klee/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!25 = metadata !{i32 589865, metadata !"memmove.c", metadata !"/home/shaw/work/klee/runtime/Intrinsic/", metadata !26} ; [ DW_TAG_file_type ]
!26 = metadata !{i32 589841, i32 0, i32 1, metadata !"memmove.c", metadata !"/home/shaw/work/klee/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!31 = metadata !{i32 589865, metadata !"stddef.h", metadata !"/usr/lib/llvm-gcc-4.2-2.9-i686-linux/bin/../lib/gcc/i686-pc-linux-gnu/4.2.1/include", metadata !26} ; [ DW_TAG_file_type ]
!32 = metadata !{i32 589860, metadata !25, metadata !"unsigned int", metadata !25, i32 0, i64 32, i64 32, i64 0, i32 0, i32 7} ; [ DW_TAG_base_type ]
...
!34 = metadata !{i32 589865, metadata !"memset.c", metadata !"/home/shaw/work/klee/runtime/Intrinsic/", metadata !35} ; [ DW_TAG_file_type ]
!35 = metadata !{i32 589841, i32 0, i32 1, metadata !"memset.c", metadata !"/home/shaw/work/klee/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!38 = metadata !{i32 589839, metadata !34, metadata !"", metadata !34, i32 0, i64 32, i64 32, i64 0, i32 0, null} ; [ DW_TAG_pointer_type ]
...
!41 = metadata !{i32 589865, metadata !"stddef.h", metadata !"/usr/lib/llvm-gcc-4.2-2.9-i686-linux/bin/../lib/gcc/i686-pc-linux-gnu/4.2.1/include", metadata !35} ; [ DW_TAG_file_type ]
!42 = metadata !{i32 589860, metadata !34, metadata !"unsigned int", metadata !34, i32 0, i64 32, i64 32, i64 0, i32 0, i32 7} ; [ DW_TAG_base_type ]
...
!48 = metadata !{i32 589839, metadata !16, metadata !"", metadata !16, i32 0, i64 32, i64 32, i64 0, i32 0, metadata !49} ; [ DW_TAG_pointer_type ]
...
!51 = metadata !{i32 589839, metadata !16, metadata !"", metadata !16, i32 0, i64 32, i64 32, i64 0, i32 0, metadata !52} ; [ DW_TAG_pointer_type ]
...
!58 = metadata !{i32 589839, metadata !25, metadata !"", metadata !25, i32 0, i64 32, i64 32, i64 0, i32 0, metadata !59} ; [ DW_TAG_pointer_type ]
...
!61 = metadata !{i32 589839, metadata !25, metadata !"", metadata !25, i32 0, i64 32, i64 32, i64 0, i32 0, metadata !62} ; [ DW_TAG_pointer_type ]
...
!68 = metadata !{i32 589839, metadata !34, metadata !"", metadata !34, i32 0, i64 32, i64 32, i64 0, i32 0, metadata !69} ; [ DW_TAG_pointer_type ]
...
!96 = metadata !{i32 58, i32 0, metadata !95, null}
!97 = metadata !{i32 61, i32 0, metadata !95, null}
!98 = metadata !{i32 63, i32 0, metadata !95, null}
